...
//3.1: Object
//3.2: job Result stored in _highlightResult and this is an Object
//3.3. Using command 
jobSearch.hits.forEach((value,index)=>{
    console.log(value.jobTitle)
    console.log(value.locations)
    console.log(value.jobSalary)
    console.log(value.benefits)
    console.log(value.skills)
    console.log(value.jobRequirement)
})